...
if __name__ == "__main__":
    eval = Evaluator(ckpt=Path("ckpt/1735274590.9468231/99.pt"))
    eval.create_memory_context()

    # from kaggle_environments import make

    # env = make("jane-street-real-time-market-data-forecasting")
    # import kaggle_evaluation.jane_street_inference_server

    # inference_server = kaggle_evaluation.jane_street_inference_server.JSInferenceServer(eval.predict)
